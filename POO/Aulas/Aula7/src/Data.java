class Data {
     ...
     * O construtor é um metodo especial que é chamado automaticamente
     ...
     *
     * Por ser um metodo especial, ele:
    ...
    // o segundo metodo construtor não faz nenhuma validação
    public Data (int dia, int mes) {
        this.dia = dia;
        this.mes = mes;
    }

    // Metodo que retorna a data no formato de texto
    ...
    // Metodo que retorna data escrita por extenso
    ...
    public static void main (String args[]) {
        ...
        // e chamamos um metodo do objeto armazenado nessa posição
