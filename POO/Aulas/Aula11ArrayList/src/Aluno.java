...
public class Aluno {
    ...
    public Aluno(String nome, String cpf, String email, int cod_curso, Data nasc){
        ...
        // agora que foi criado o metodo setCurso, chamamos ele para fazer a validação e atribuição
        setCurso(cod_curso);
    ...
    public static void main (String args[]) {
        ...
        // Para alterar o valor de um atributo, devemos utilizar o metodo SET,
        ...
        // Para acessar o valor, utilizamos o metodo GET,
